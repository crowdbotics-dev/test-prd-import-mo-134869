"""
Django settings for test_prd_import_mo_134869 project.
...
ROOT_URLCONF = 'test_prd_import_mo_134869.urls'
...
WSGI_APPLICATION = 'test_prd_import_mo_134869.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_import_mo_134869 API",
    "DESCRIPTION": "API documentation for test_prd_import_mo_134869 App",
    "VERSION": "v1",
}
